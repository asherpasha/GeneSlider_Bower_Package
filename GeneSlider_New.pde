                ...
                if (jsonClone.gff[i].data[j][0].equals("JASPAR")) {
                    if (jsonClone.gff[i].data[k][0].equals("JASPAR")) {
                        ...
                        if (checkOverlap(jsonClone.gff[i].data[j][1], jsonClone.gff[i].data[j][2], jsonClone.gff[i].data[k][1], jsonClone.gff[i].data[k][2])) {
                            if ((jsonClone.gff[i].data[k].length == 8) && (jsonClone.gff[i].data[j].length == 8)) {
                                if (jsonClone.gff[i].data[k][7] >= jsonClone.gff[i].data[j][7]) { 
                                    jsonClone.gff[i].data[j][7] = jsonClone.gff[i].data[k][7] + 1;
                                } else {
                                    jsonClone.gff[i].data[j][7] = jsonClone.gff[i].data[j][7] + 1;
                                }
                            } else if ((jsonClone.gff[i].data[k].length == 8) && (jsonClone.gff[i].data[j].length == 7)) {
                                append(jsonClone.gff[i].data[j], jsonClone.gff[i].data[k][7] + 1);
                            } else if ((jsonClone.gff[i].data[k].length == 7) && (jsonClone.gff[i].data[j].length == 8)) {
                                append(jsonClone.gff[i].data[k], jsonClone.gff[i].data[j][7] + 1);
                            } else {
                                append(jsonClone.gff[i].data[j], 1);
                                append(jsonClone.gff[i].data[k], 2);
                            }
                        }
                    }
                }
